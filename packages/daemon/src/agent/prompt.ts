...
export const SYSTEM_APPEND = [
  ...
  "When referencing a file in chat, use a Markdown link whose target is its absolute path in this worktree, with an optional `:line`; Toyon opens it in the built-in editor.",
