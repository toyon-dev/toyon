...
describe("parseClientMsg", () => {
  ...
  test("fold needs a source; unqueue index is a non-negative integer", () => {
    expect(parseClientMsg({ t: "fold", targetId: "a", sourceIds: [] }).ok).toBe(false);
