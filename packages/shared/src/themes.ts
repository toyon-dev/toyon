...
export const tokyoNight: Theme = {
  ...
  colors: {
    bg0: "#1a1b26", bg1: "#16161e", bg2: "#13131a", bg3: "#101014",
    fg1: "#a9b1d6", fgMuted: "#515670", fgDim: "#545c7e",
    red: "#f7768e", orange: "#3d59a1", yellow: "#e0af68", green: "#73daca",
    aqua: "#7dcfff", blue: "#7aa2f7", purple: "#bb9af7",
    addBg: "#41a6b520", delBg: "#db4b4b22",
    scrim: "#1a1b26b3", shadow: "#00000066",
  },
  syntax: { comment: "#51597d", keyword: "#bb9af7", string: "#9ece6a", number: "#ff9e64", type: "#0db9d7", function: "#0db9d7", variable: "#c0caf5" },
};
...
export const tokyoNightLight: Theme = {
  ...
  pair: "tokyo-night",
  colors: {
    bg0: "#e6e7ed", bg1: "#d6d8df", bg2: "#e1e2e8", bg3: "#c1c2c7",
    fg1: "#343b59", fgMuted: "#707280", fgDim: "#707280",
    red: "#8c4351", orange: "#2959aa", yellow: "#8f5e15", green: "#33635c",
    aqua: "#006c86", blue: "#2959aa", purple: "#7b43ba",
    addBg: "#2d9c9120", delBg: "#e8686812",
    scrim: "#e6e7edb3", shadow: "#0000002e",
  },
  syntax: { comment: "#888b94", keyword: "#65359d", string: "#385f0d", number: "#965027", type: "#006c86", function: "#006c86", variable: "#343b58" },
};
...
export const rosePine: Theme = {
  ...
  pair: "rose-pine-dawn",
  colors: {
    bg0: "#191724", bg1: "#191724", bg2: "#221f2e", bg3: "#191724",
    fg1: "#e0def4", fgMuted: "#908caa", fgDim: "#908caa",
    red: "#eb6f92", orange: "#ebbcba", yellow: "#f6c177", green: "#31748f",
    aqua: "#ebbcba", blue: "#9ccfd8", purple: "#c4a7e7",
    addBg: "#9ccfd826", delBg: "#eb6f9226",
    scrim: "#191724b3", shadow: "#00000066",
  },
  syntax: { comment: "#6e6a86", keyword: "#31748f", string: "#f6c177", number: "#ebbcba", type: "#9ccfd8", function: "#eb6f92", variable: "#ebbcba" },
};
...
export const rosePineDawn: Theme = {
  ...
  pair: "rose-pine",
  colors: {
    bg0: "#faf4ed", bg1: "#faf4ed", bg2: "#f3ede8", bg3: "#faf4ed",
    fg1: "#575279", fgMuted: "#797593", fgDim: "#797593",
    red: "#b4637a", orange: "#d7827e", yellow: "#ea9d34", green: "#286983",
    aqua: "#d7827e", blue: "#56949f", purple: "#907aa9",
    addBg: "#56949f26", delBg: "#b4637a26",
    scrim: "#faf4edb3", shadow: "#0000002e",
  },
  syntax: { comment: "#9893a5", keyword: "#286983", string: "#ea9d34", number: "#d7827e", type: "#56949f", function: "#b4637a", variable: "#d7827e" },
};
...
export const oneDarkPro: Theme = {
  ...
  pair: "one-light",
  colors: {
    bg0: "#282c34", bg1: "#21252b", bg2: "#2c313a", bg3: "#3e4452",
    fg1: "#abb2bf", fgMuted: "#abb2bf", fgDim: "#495162",
    red: "#e05561", orange: "#4d78cc", yellow: "#d18f52", green: "#8cc265",
    aqua: "#42b3c2", blue: "#4aa5f0", purple: "#c162de",
    addBg: "#00809b33", delBg: "#e055611f",
    scrim: "#282c34b3", shadow: "#00000066",
  },
  syntax: { comment: "#7f848e", keyword: "#c678dd", string: "#98c379", number: "#d19a66", type: "#e5c07b", function: "#56b6c2", variable: "#e06c75" },
};
...
export const oneLight: Theme = {
  ...
  pair: "one-dark-pro",
  colors: {
    bg0: "#fafafa", bg1: "#eaeaeb", bg2: "#e4e4e5", bg3: "#e5e5e6",
    fg1: "#383a42", fgMuted: "#3b3b3b", fgDim: "#9d9d9f",
    red: "#cd3131", orange: "#526fff", yellow: "#949800", green: "#00bc00",
    aqua: "#0598bc", blue: "#0451a5", purple: "#bc05bc",
    addBg: "#00809b33", delBg: "#cd31311f",
    scrim: "#fafafab3", shadow: "#0000002e",
  },
  syntax: { comment: "#a0a1a7", keyword: "#a626a4", string: "#50a14f", number: "#986801", type: "#0184bc", function: "#0184bc", variable: "#e45649" },
};
...
export const solarizedDark: Theme = {
  ...
  colors: {
    bg0: "#002b36", bg1: "#00212b", bg2: "#003846", bg3: "#2b2b4a",
    fg1: "#839496", fgMuted: "#93a1a1", fgDim: "#4a6166",
    red: "#dc322f", orange: "#197271", yellow: "#b58900", green: "#859900",
    aqua: "#2aa198", blue: "#268bd2", purple: "#d33682",
    addBg: "#8599001f", delBg: "#dc322f1f",
    scrim: "#002b36b3", shadow: "#00000066",
  },
  syntax: { comment: "#586e75", keyword: "#859900", string: "#2aa198", number: "#d33682", type: "#859900", function: "#268bd2", variable: "#268bd2" },
};
...
export const solarizedLight: Theme = {
  ...
  pair: "solarized-dark",
  colors: {
    bg0: "#fdf6e3", bg1: "#eee8d5", bg2: "#eae0c0", bg3: "#ddd6c1",
    fg1: "#657b83", fgMuted: "#586e75", fgDim: "#a3aba5",
    red: "#dc322f", orange: "#b58900", yellow: "#b58900", green: "#859900",
    aqua: "#2aa198", blue: "#268bd2", purple: "#d33682",
    addBg: "#8599001f", delBg: "#dc322f1f",
    scrim: "#fdf6e3b3", shadow: "#0000002e",
  },
  syntax: { comment: "#93a1a1", keyword: "#859900", string: "#2aa198", number: "#d33682", type: "#859900", function: "#268bd2", variable: "#268bd2" },
};
...
export const nord: Theme = {
  ...
  source: "builtin",
  colors: {
    bg0: "#2e3440", bg1: "#2e3440", bg2: "#3b4252", bg3: "#3b4252",
    fg1: "#d8dee9", fgMuted: "#c7cdd8", fgDim: "#4c566a",
    red: "#bf616a", orange: "#88c0d0", yellow: "#ebcb8b", green: "#a3be8c",
    aqua: "#88c0d0", blue: "#81a1c1", purple: "#b48ead",
    addBg: "#81a1c133", delBg: "#bf616a4d",
    scrim: "#2e3440b3", shadow: "#00000066",
  },
  syntax: { comment: "#616e88", keyword: "#81a1c1", string: "#a3be8c", number: "#b48ead", type: "#8fbcbb", function: "#88c0d0", variable: "#d8dee9" },
};
...
export const catppuccinMocha: Theme = {
  ...
  colors: {
    ...
    fg1: "#cdd6f4", fgMuted: "#a6adc8", fgDim: "#7f849c",
    red: "#f38ba8", orange: "#fab387", yellow: "#f9e2af", green: "#a6e3a1",
    aqua: "#94e2d5", blue: "#89b4fa", purple: "#cba6f7",
    addBg: "#a6e3a11f", delBg: "#f38ba81f",
    scrim: "#1e1e2eb3", shadow: "#00000066",
  },
  syntax: { comment: "#9399b2", keyword: "#cba6f7", string: "#a6e3a1", number: "#fab387", type: "#f9e2af", function: "#89b4fa", variable: "#cdd6f4" },
};
...
export const catppuccinLatte: Theme = {
  ...
  colors: {
    ...
    fg1: "#4c4f69", fgMuted: "#6c6f85", fgDim: "#8c8fa1",
    red: "#d20f39", orange: "#fe640b", yellow: "#df8e1d", green: "#40a02b",
    aqua: "#179299", blue: "#1e66f5", purple: "#8839ef",
    addBg: "#40a02b1f", delBg: "#d20f391f",
    scrim: "#eff1f5b3", shadow: "#0000002e",
  },
  syntax: { comment: "#7c7f93", keyword: "#8839ef", string: "#40a02b", number: "#fe640b", type: "#df8e1d", function: "#1e66f5", variable: "#4c4f69" },
};

const communityThemes: Theme[] = [tokyoNight, tokyoNightLight, rosePine, rosePineDawn, oneDarkPro, oneLight, solarizedDark, solarizedLight, nord, catppuccinMocha, catppuccinLatte];
...
export interface ThemeFamily { name: string; dark?: Theme; light?: Theme }
...
export function themeFamilies(themes: Theme[]): ThemeFamily[] {
  ...
  const derive = (t: Theme) => t.family ?? (t.name.replace(/\b(dark|light)\b/gi, "").replace(/\s+/g, " ").trim() || t.name);
  for (const t of themes) {
    ...
    fam[t.kind] = t;
    seen.add(t.id);
    if (sib) { fam[sib.kind] = sib; seen.add(sib.id); }
    out.push(fam);
  }
  return out;
}
