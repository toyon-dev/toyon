...
/** Rides behind the first message on an empty project, out of the transcript, one paragraph of
 * the block Toyon attaches. The agent picks the stack from what the message describes; nothing
 * here is a scaffold toyon runs. */
